...
LabeledScatterPlot(z, point.size = 3, label.font.size = 2, legend.font.size = 10,   axis.title.font.size = 12, axis.label.font.size = 10, title.font.size = 12)



LabeledScatterPlot(z, point.size = 3, label.font.size = 50, legend.font.size = 10, axis.title.font.size = 12, axis.label.font.size = 10, title.font.size = 12)
